...
RUN --mount=type=cache,id=s/fef67e3a-202b-492c-82b7-0cdd77736926-/root/.local/share/pnpm/store,target=/root/.local/share/pnpm/store,sharing=locked \
...
RUN --mount=type=cache,id=s/fef67e3a-202b-492c-82b7-0cdd77736926-/var/cache/apt,target=/var/cache/apt,sharing=locked \
    --mount=type=cache,id=s/fef67e3a-202b-492c-82b7-0cdd77736926-/var/lib/apt,target=/var/lib/apt,sharing=locked \
    apt-get update && \
